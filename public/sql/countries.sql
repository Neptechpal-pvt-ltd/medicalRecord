...
CREATE TABLE `countries` (
  ...
  `name_dev` varchar(191) COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `nationality` varchar(191) COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `nationality_dev` varchar(191) COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
