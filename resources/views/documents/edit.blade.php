                    ...
                    <div class="mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" value="{{$document->father_name}}" class="form-control @error('father_name') is-invalid @enderror "
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" value="{{$document->father_name_dev}}" class="form-control @error('father_name_dev') is-invalid @enderror "
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" value="{{$document->mother_name}}" class="form-control @error('mother_name') is-invalid @enderror "
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" value="{{$document->mother_name_dev}}" class="form-control @error('mother_name_dev') is-invalid @enderror "
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="father_nationality" id="father_nationality" class="selectize-select">
                                    ...
                                    <option {{$document->father_nationality === $country->id ? 'selected' : ''}} value="{{$country->id}}">{{$country->name}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="mother_nationality" id="mother_nationality" class="selectize-select">
                                    @foreach ($countries as $country)
                                    <option {{$document->mother_nationality === $country->id ? 'selected' : ''}} value="{{$country->id}}">{{$country->name}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <select name="gender" id="gender"
                                        ...
                                        <option {{$document->gender ==='MALE' ? 'selected' : '' }} value="MALE">Male</option>
                                        <option {{$document->gender ==='FEMALE' ? 'selected' : '' }} value="female">Female
                                        </option>
                                        <option {{$document->gender ==='OTHER' ? 'selected' : '' }} value="other">Other
                                        </option>
                                    </select>
                                    @error('gender')
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <select id="province_id" name="province_id"
                                        ...
                                        <option {{$document->province_id === $province->id ? 'selected' : ''}} value="{{ $province->id }}">{{ $province->province_name }}
                                        </option>
                                        @endforeach
                                    </select>
                                    @error('province_id')
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <select id="district_id" name="district_id"
                                        ...
                                        <option {{$document->district_id === $district->id ? 'selected' : ''}} value="{{ $district->id }}">{{ $district->district_name }}
                                        @endforeach
                                    </select>
                                    @error('district_id')
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <select id="municipal_id" name="municipal_id"
                                        ...
                                        <option {{$document->municipal_id === $municipal->id ? 'selected' : ''}} value="{{ $municipal->id }}">{{ $municipal->municipal_name }}
                                        @endforeach
                                    </select>
                                    @error('municipal_id')
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <input type="number" name="ward_no" id="t-ward"
                                        ...
                                        value="{{ $document->ward_no }}" placeholder="Ward No">
                                    @error('ward_no')
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="address" id="t-tole"
                                        ...
                                        value="{{ $document->address }}" placeholder="Tole">
                                    @error('address')
                                    <span class="invalid-feedback" role="alert">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <input type="text" id="registered_date_bs" name="registered_date_bs"
                                            ...
                                            value="{{ $document->registered_date_bs }}">
                                    ...
                                    <div class="col-md-6">
                                        <input type="date" id="registered_date" name="registered_date" readonly
                                            class="form-control @error('registered_date') is-invalid @enderror"
                                            value="{{ $document->registered_date }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('certificate_no') is-invalid @enderror "
                                    id="certificate_no" name="certificate_no" value="{{$document->certificate_no}}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('ip_no') is-invalid @enderror " id="ip_no" value="{{$document->ip_no}}"
                                    name="ip_no">
                                @error('ip_no')
                                <div class="invalid-feedback">
                                    {{$errors->first('ip_no')}}
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('approved_by') is-invalid @enderror "
                                    id="approved_by" name="approved_by" value="{{$document->approved_by}}">
                                @error('approved_by')
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('verified_by') is-invalid @enderror "
                                    id="verified_by" name="verified_by" value="{{$document->verified_by}}">
                                @error('verified_by')
                                <div class="invalid-feedback">
